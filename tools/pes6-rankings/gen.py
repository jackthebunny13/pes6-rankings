...
SITE_TEAMS = {'Atalanta', 'Arsenal', 'Ajax', 'Feyenoord', 'PSV Eindhoven', 'Real Madrid', 'Inter', 'Milan', 'Juventus', 'Fiorentina', 'Genoa', 'Lazio', 'Cagliari', 'Roma', 'Brescia', 'Lecce', 'Liverpool', 'Manchester United'}
